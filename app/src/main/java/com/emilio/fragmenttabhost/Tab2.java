...
public class Tab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        et_valor1 = (EditText) vista.findViewById(R.id.txt_valor1);
        et_valor2 = (EditText) vista.findViewById(R.id.txt_valor2);
        rb_sum = (RadioButton) vista.findViewById(R.id.rb_sumar);
        rb_rest = (RadioButton) vista.findViewById(R.id.rb_restar);
        rb_mul = (RadioButton) vista.findViewById(R.id.rb_producto);
        rb_div = (RadioButton) vista.findViewById(R.id.rb_division);
        tv_result = (TextView) vista.findViewById(R.id.tv_resultado);
